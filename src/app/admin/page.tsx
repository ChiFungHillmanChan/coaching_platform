...
import { Search, Sun, Moon, LogOut, Mail, Users, BarChart3, Shield, AlertCircle } from "lucide-react";
...
export default function AdminPage() {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mt-4 text-gray-900">Verifying Access...</h3>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mt-4 text-gray-900">Access Denied</h3>
            <p className="text-sm text-gray-500 mt-2">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <Header adminEmail={userEmail} currentPage={page} onNavigate={setPage} dark={dark} setDark={setDark} onLogout={logout} />
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 text-xs text-gray-500 dark:text-gray-400">
          © {new Date().getFullYear()} AI Coaching Admin. Professional admin panel.
        </div>
      </footer>
    </div>
  );

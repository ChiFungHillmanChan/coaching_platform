...
export interface ContentBlock {
  type: 'text' | 'heading' | 'code' | 'code_popup' | 'code_pop_up' | 'search bar' | 'image' | 'video' | 'youtube_video' | 'list' | 'card' | 'callout' | 'blockquote' | 'link' | 'line-break' | 'horizontal-rule' | 'terminal' | 'table' | 'task-list' | 'download-link' | 'footnote' | 'definition-list';
  content: string;
